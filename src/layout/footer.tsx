...
export const Footer: React.FC = () => (
  <footer className='flex flex-col items-center justify-center w-full h-20 sm:h-24 text-center border-t border-grey p-4 pin-b pointer-events-auto text-sm lg:text-base'>
