...
他には、大学の実験([Pascal のサブセット言語のコンパイラを作るやつ](https://github.com/hppRC/CSE3))がかなり楽しかったのと、3年の他の学期に比べると課題が少なくて楽な学期だった記憶があります。でも講義は大体寝ていた気がします🤔
...
まず、期末テストがあって、無事単位を全てとって学期を終えることができました。
...
traP の方のチームがめちゃくちゃ強かったのを覚えています(1, 2, 4 位が traP の人だった気がする)。ここらへんから、コミュニティの中で開発する良さみたいなものを感じるようになった気がします。

4位のチームの方とは、3月のインターンで再びエンカするという面白い巡り合わせがありました。人間っていろんな場所にいて面白いですね。


# 3月

CyberAgent さんの CA Tech Job というインターンに参加させていただきました。このインターンは僕の転機とも言えるものになりました。というのも、それまで技術的に優れた方に師事する機会というものがなかったので、メンターの方にタスクに関するわからないことや業務内外の技術の話、web 技術全般に関する話や思いっきり趣味の話など、自分の知らない世界をたくさん教えていただく初めての経験になりました。

メンターの方はもちろん、困ったら常に相談に乗ってくれた同じチームの方も、焼肉をご一緒した他の部署の方も、すべて記憶に残っています(業務外のボルダリングも)。

業務内容的には、もっと多くのことを、もっと質を上げてやっていきたかったという気持ちがあります。もっと技術力あげたいなという気持ちが強くなりました。
...
あと研究室配属の振り分けが進んでいました。 Google Spraed Sheed に希望研究室を書くという方式だったのですが、合理的だが味気ないみたいな３分の1の純情な感情というお心持ち。
...
画像系の研究室と音響信号処理の研究室、データベースの研究室もあって迷ったのですが、僕が配属された研究室にもともとお世話になっていた先輩がおり、しっかり研究できる雰囲気を聞いていたので、希望としてはほぼ一択の状況でした。この判断は間違っていなかったと思います。
...
うちの研究室では、研究テーマは所与のものではなく、自分でやりたいことを考える感じなので、テーマ探しも結構大変でした。
...
名文検索用のクエリは[こちら](https://twitter.com/search?q=from%3A%40ujimaru0000%20min_faves%3A5&src=typed_query)です。
